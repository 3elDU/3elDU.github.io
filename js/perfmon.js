...
function disableEffects() {
  ...
  main.style.backgroundColor =
    computedStyle.getPropertyValue("--fallback-main-bg");

  for (const card of document.getElementsByClassName("card")) {
    card.style.backgroundColor =
      computedStyle.getPropertyValue("--fallback-card-bg");
  }

  for (const subcard of document.getElementsByClassName("subcard")) {
    subcard.style.backgroundColor = computedStyle.getPropertyValue(
      "--fallback-subcard-bg"
    );
  }
